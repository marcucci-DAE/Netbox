...
def retrieve_devices(base_url, headers, site):
	...
	#?q=&site={site}&status=1&platform=red-hat-enterprise-linux-6-64-bit&platform=red-hat-enterprise-linux-7-64-bit&limit=0'.format(site=site)
...
def main():
    ...
    base_url = 'http://10.39.135.154/api'
    headers = {
